...
def run(input_dir, rule_folder):
    ...
    all_results.to_excel("/home/shovan/nlputils/EDG_framework/Lexical_Concepts/Outputs/Chapter/outputV2.xlsx", index=False)
    blacklisted_results.to_excel("/home/shovan/nlputils/EDG_framework/Lexical_Concepts/Outputs/Chapter/blacklist_outputV2.xlsx", index=False)
