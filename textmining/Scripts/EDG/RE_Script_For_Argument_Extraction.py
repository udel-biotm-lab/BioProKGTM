...
def run(input_dir, rule_folder):
    ...
    dictionary_file = "/home/shovan/nlputils/EDG_framework/Lexical_Concepts/Concepts_and_Dictionary/transformed_data1.json"  #Change the path of the dictionary file
