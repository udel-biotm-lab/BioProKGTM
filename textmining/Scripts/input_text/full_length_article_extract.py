...
if __name__ == '__main__':
    if len(sys.argv) != 4:
        print("Usage: python script.py <input_directory_path> <output_directory_path1> <output_directory_path2>")
        sys.exit(1)

    input_directory_path = sys.argv[1]
    output_directory_path1 = sys.argv[2]
    output_directory_path2 = sys.argv[3]
