...
affector_nodes, affected_nodes, affector_class_nodes, affected_class_nodes, relations = controller.get_base_values()
...
with col2: start_node_class = st.selectbox('Class of Affector (subject)',affector_class_nodes,index=None)

with col3: end_node = st.selectbox('End Node / Object / Affected',affected_nodes,index=None)
with col4: end_node_class = st.selectbox('Class of Affected (object)',affected_class_nodes,index=None)
